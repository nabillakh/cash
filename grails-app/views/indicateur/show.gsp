	...
	<body>
		...
		<div id="show-indicateur" class="content scaffold-show" role="main">
			...
			<ol class="property-list indicateur">
				...
				<g:if test="${indicateurInstance?.code}">
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="indicateur.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${indicateurInstance}" field="code"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${indicateurInstance?.definition}">
				<li class="fieldcontain">
					<span id="definition-label" class="property-label"><g:message code="indicateur.definition.label" default="Definition" /></span>
					
						<span class="property-value" aria-labelledby="definition-label"><g:fieldValue bean="${indicateurInstance}" field="definition"/></span>
