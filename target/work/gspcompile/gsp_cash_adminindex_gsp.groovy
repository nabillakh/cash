...
class gsp_cash_adminindex_gsp extends GroovyPage {
...
invokeTag('form','g',18,['action':("save"),'method':("post"),'enctype':("multipart/form-data")],2)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1416838589464L
